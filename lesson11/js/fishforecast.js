const apiUrl = "https://api.openweathermap.org/data/2.5/forecast?lat=42.0380399&lon=-111.4048681&units=imperial&appid=da128f49ff6764aa1db304e6e5202919";
...
async function retrieveData() {
    ...
    var todaysdate = new Date();
        ...
        const dayfour = dayNames[todaysdate.getDay() + 4];
        const dayfive = dayNames[todaysdate.getDay() + 5];
